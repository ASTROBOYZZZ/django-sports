                    ...
                    <ul class="accordion-menu">
                        <li class="open active">
                            ...
                            <ul class="sub-menu" style="display: block;">
                                ...
                                <li class="active"><a href="machine_info.php?mac_id=0">农机信息</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <!-- <li class><a href="admin_machine_work_info.php">农机工作信息</a></li> -->
                                <!-- <li class><a href="admin_work_info.php">工作信息</a></li> -->
                            </ul>
                        </li>
                        <!-- del left -->
            ...
            <div class="page-inner">
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card mg-b-20">
                        ...
                        <form action="user_add_order.php" method="post" id="1">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-layout form-layout-4">
                                            ...
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label  tx-14 tx-md-24 tx-dark "> <span class="tx-danger"></span>机器名:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-dark" value="<?php echo $name ?>" readonly>
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-20">
                                                ...
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-dark" value="<?php echo $ser_num; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark ">功能: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-dark" value="<?php echo $func; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark ">购置日期: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="date" formid="1" class="tx-14 tx-md-20 tx-dark" value="<?php echo $date; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark ">所有人: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-dark" value="<?php echo $owner; ?>" readonly>
                                                </div>
                                            </div>
                                            <!-- form-layout-footer -->
                                        </div>
                                    ...
                                    <div class="col-xl-6 mg-t-20 mg-xl-t-0">
                                        <div class="form-layout form-layout-5">
                                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 tx-md-20 mg-b-10">生成订单</h6>
                                            <p class="mg-b-30 tx-gray-600">机器状态.</p>
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-20 tx-dark"><span class="tx-danger"></span> 工作面积:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" name = "mac_area" class="tx-14 tx-md-20 tx-dark" value="<?php echo $area; ?>" readonly>
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-20 tx-dark"><span class="tx-danger"></span> 可用度:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" name = "mac_usable" class="tx-14 tx-md-20 tx-dark" value="<?php echo $usable; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-20 tx-dark"><span class="tx-danger"></span> 机器状态:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-<?php echo ($lent||$row['repaired']) ? "danger" : "success"; ?>" value="<?php echo $lent ? "工作中" :($row['repaired']?"修理中":"未工作"); ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-20 tx-dark"><span class="tx-danger"></span> 租金:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-20 tx-dark" placeholder="请输入租金" name="ord_value" required>
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-30">
                                                <div class="col-sm-8 mg-l-auto">
                                                    <div class="form-layout-footer">
                                                        <input type="submit" formid="1" class="btn btn-custom-primary" name="sub_ord" value="生成订单">
