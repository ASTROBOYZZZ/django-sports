                  ...
                  <ul class="accordion-menu">
                     ...
                     <li>
                        ...
                        <ul class="sub-menu">
                           ...
                           <li class = "active"><a href="admin_machine_work_center.php">农机工作信息</a></li>
                                    ...
                                    <table class="table table-hover mb-0">
                                       <thead class="tx-dark tx-uppercase tx-10 tx-bold">
                                          <tr>
                                             ...
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">操作人手机号</th>
                                       ...
                                       <tbody>
                                          <?php
                                                ...
                                                if($conn){
                                                    ...
                                                    $sql_select = "select * from misaki_joy.machine_work where mac_id = $mac_id";
                                                        //set code 
                                                    ...
                                                    if($sql_return)
                                                    {
                                                      while($row = mysqli_fetch_array($sql_return))
                                                      {
                                                         ...
                                                         //  echo $len;
                                                          ...
                                                          echo "<td class=\"tx-center tx-14 tx-md-24 tx-dark\">" . $row['phone'] . "</td>\n";
                                                          ...
                                                          echo "<td class=\"tx-center tx-14 tx-md-24 tx-dark\">" . $row['ret_id'] . "</a></td>\n";
                                                          echo "</tr>\n";
                                                      }
                                                    } 
                                                }
