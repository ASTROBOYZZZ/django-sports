                                    ...
                                    <table class="table table-hover mb-0">
                                       <thead class="tx-dark tx-uppercase tx-10 tx-bold">
                                          <tr>
                                             ...
                                             <th class="tx-center tx-14 tx-md-20 tx-dark">操作人手机号</th>
                                             ...
                                             <th class="tx-center tx-14 tx-md-20 tx-dark">还单序号</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                          <?php
                                                    ...
                                                    if($sql_return)
                                                    {
                                                      while($row = mysqli_fetch_array($sql_return))
                                                      {
                                                         ...
                                                         //  echo $len;
                                                          ...
                                                          echo "<td class=\"tx-center tx-14 tx-md-24 tx-dark\">" . $loc_work[$cnt][3] . "</td>\n";
