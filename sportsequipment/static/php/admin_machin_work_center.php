...
<html lang="zxx">
   <head>
      ...
      <title>Admin Center | Joy Machine Info Manage Center</title>
      <!-- Main CSS -->			
      ...
      <div class="page-container">
               ...
               <div class="page-sidebar-menu">
                  <ul class="accordion-menu">
                     ...
                     <li>
                        ...
                        <span>农机工作信息</span></a>
                        <ul class="sub-menu">
                           <li class="active"><a href="admin_machine_work_center.php">信息中心</a></li>
         ...
         <div class="col-md-12 col-lg-8">
            <div class="card mg-b-20">
               ...
               <span class="tx-14 tx-md-24 tx-dark">按机器检索</span>
                              </h4>
               ...
               <form action="admin_machine_work_info.php" method="get" id="2">
                  <div class="card-body collapse show" id="collapse4">
                     <div class="row">
                        <div class="col-lg-8">
                           <div class="form-layout form-layout-4">
                              <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 tx-md-24 tx-dark mg-b-10">输入想要查询的机器序号</h6>
                              <p class="mg-b-30 tx-gray-600"></p>
                              <div class="row">
                                 <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">机器序号: <span
                                       class="tx-danger"></span></label>
                                 <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <input type="text" formid="2" class="form-control" name="mac_id" required>
                                 </div>
                              </div>
                              <!-- row -->
                ...
                <!-- 作业概况 Start -->
                     ...
                     <div class="col-sm-12 col-xl-12">
                        <div class="card mg-b-20">
                           <div class="card-header">
                              <h4 class="card-header-title">
                                 <span class="tx-14 tx-md-24 tx-dark">作业信息概况</span>
                              </h4>
                              <div class="card-header-btn">
                                 ...
                                 <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                       <thead class="tx-dark tx-uppercase tx-10 tx-bold">
                                          <tr>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">作业序号</th>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">机器编号</th>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">开始作业时间</th>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">结束作业时间</th>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">作业地点</th>
                                             <th class="tx-center tx-14 tx-md-24 tx-dark">作业面积</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                          <?php
                                                ...
                                                if($conn){
                                                    ...
                                                    $sql_select = "select * from misaki_joy.machine_work";
                                                        //set code 
                                                    ...
                                                    if($sql_return)
                                                    {
                                                      while($row = mysqli_fetch_array($sql_return))
                                                      {
                                                         ...
                                                         //  echo $len;
                                                          ...
                                                          $web_loc = "<a href='admin_work_info.php?work_id=" . $row['id'] . "'>" . $row['id'] ;
                                                          echo "<tr>\n";
                                                          ...
                                                          echo "<td class=\"tx-center tx-14 tx-md-24 tx-purple\">" . $loc_work[$cnt][1] . "</span></td>\n";
                    ...
                    <!-- Overly Map Start -->
                     ...
                     <div class="col-md-6 col-lg-6">
                        <div class="card mg-b-20">
                           <div class="card-header">
                              <h4 class="card-header-title">
                                  <span class="tx-14 tx-md-24 tx-dark">工作地点及路径展示</span>
                              </h4>
                              <div class="card-header-btn">
                           ...
                           <?php if($cnt) include 'machine_work_map.php'; else echo "<h4>该机器暂无工作记录</h4>";?>
