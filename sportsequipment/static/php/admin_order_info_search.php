...
<head>
    ...
    <title>订单检索 | Joy Machine Info Manage Center</title>
    <!-- Main CSS -->
            ...
            <div id="main-wrapper">
               ...
               <div class="pageheader pd-t-25 pd-b-35">
                  <div class="pd-t-5 pd-b-5">
                     <h1 class="pd-0 mg-0 tx-20">订单查询 | Order Searching</h1>
                  </div>
                  <div class="breadcrumb pd-0 mg-0">
                     <a class="breadcrumb-item" href="index.html"><i class="icon ion-ios-home-outline"></i> Home</a>
                     <a class="breadcrumb-item" href="">Dashboard</a>
                     <!-- here to design -->
                     <span class="breadcrumb-item active">Order Searching</span>
                  </div>
               </div>
               <!--/ Breadcrumb End -->
               <!--================================-->
         ...
         <div class="col-md-12 col-lg-12">
            <div class="card mg-b-20">
               ...
               <h4 class="card-header-title">
                     <span class="tx-14 tx-md-24 tx-dark">按序号查询订单</span>
                  </h4>
               ...
               <form action="admin_order_info.php" method="get" id="2">
                  <div class="card-body collapse show" id="collapse4">
                     <div class="row">
                        <div class="col-xl-6">
                           <div class="form-layout form-layout-4">
                              <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 tx-md-24 tx-dark mg-b-10">输入想要查询的订单序号</h6>
                              <p class="mg-b-30 tx-gray-600">订单参数.</p>
                              <div class="row">
                                 <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">订单序号: <span
                                       class="tx-danger">*</span></label>
                                 <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <input type="text" formid="2" class="form-control" name="ord_id" required>
                                 </div>
                              </div>
                              <!-- row -->
                              <div class="row mg-t-30">
                                 <div class="col-sm-8 mg-l-auto">
                                    <div class="form-layout-footer">
                                       <input type="submit" formid="2" class="btn btn-custom-primary" name="sub_ord"
                                          value="查询">
        ...
        <!-- 订单概况 Start -->
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="card mg-b-20">
                        <div class="card-header">
                            <h4 class="card-header-title">
                                <span class="tx-14 tx-md-24 tx-dark">订单概况</span>
                            </h4>
                            <div class="card-header-btn">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                        <thead class="tx-dark tx-uppercase tx-10 tx-bold">
                                            <tr>
                                                <th class="tx-center tx-14 tx-md-20 tx-dark">订单序号</th>
                                                <th class="tx-center tx-14 tx-md-20 tx-dark">机器编号</th>
                                                <th class="tx-center tx-14 tx-md-20 tx-dark">申请时间</th>
                                                <th class="tx-center tx-14 tx-md-20 tx-dark">租金</th>
                                                <th class="tx-center tx-14 tx-md-20 tx-dark">审批状态</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                if($conn){
                                                    //link success
                                                    $sql_select = "select * from misaki_joy.order where misaki_joy.order.accept = 0";
                                                        //set code 
                                                    ...
                                                    if($sql_return)
                                                    {
                                                        ...
                                                        {
                                                            $acc1 = "<a href = 'admin_order_info.php?ord_id=". $row['id'] . "'>";// 已通过</a>";
                                                            ...
                                                            echo "<td class=\"tx-center tx-14 tx-md-20 tx-dark\">" . "<a href = 'admin_order_info?ord_id=". $row['id'] . "'>" . $row['id'] . "</a></td>";
                                                            echo "<td class=\"tx-center tx-14 tx-md-20 tx-dark\">" . $row['mac_id'] . "</td>";
                                                            echo "<td class=\"tx-center tx-14 tx-md-20 tx-dark\">" . $row['date'] . "</td>";
                                                            echo "<td class=\"tx-center tx-14 tx-md-20 tx-dark\">" . $row['value'] . "</td>";
                                                            echo "<td class=\"tx-center\"><span class=\"badge badge-outlined badge-" .$lent_col . "\">" . $acc1 . "</span></td>\n";
