...
setrawcookie('mac_id', $mac_id);

if ($mac_id == 0) {
    header('location:admin_machine_info_search.html');
    exit;
}
                    ...
                    <ul class="accordion-menu">
                        <li class="open active">
                            ...
                            <ul class="sub-menu" style="display: block;">
                                ...
                                <li class="active"><a href="admin_machine_info.php?mac_id=0">农机信息</a></li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="admin_machine_work_center.php">农机工作信息</a></li>
                                <li><a href="admin_machine_work_center.php">工作信息</a></li>
                            </ul>
                        </li>
                        <!-- del left -->
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    ...
                    <div class="pageheader pd-t-25 pd-b-35">
                        <div class="pd-t-5 pd-b-5">
                            <h1 class="pd-0 mg-0 tx-20">农机详细信息</h1>
                        </div>
                ...
                if ($conn) {
                    ...
                    if ($sql_return) {
                        ...
                        $lent_time = $row['lent_time'];
                        $lent1 = $row['lent']?"使用中":"空闲";
                        // $lent_col = $row['lent']?"warning":"success";
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card mg-b-20">
                        <div class="card-header">
                            <h4 class="card-header-title tx-14  tx-md-24 tx-dark">
                                <span class="tx-14 tx-md-24 tx-dark">农机信息表</span>
                              </h4>
                        ...
                        <form action="<?php echo $lent?"":"machine_update.php"?>" method="post" id="1">
                            <div class="card-body collapse show" id="collapse4">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-layout form-layout-4">
                                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 tx-md-24 mg-b-10">机器信息</h6>
                                            <p class="mg-b-30 tx-gray-600">机器参数.</p>
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">机器名: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" name = "name" value="<?php echo $name ?>" >
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">编号: <span class="tx-danger"> </span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" name = "ser_num" value="<?php echo $ser_num; ?>" >
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">序号: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" name = "mac_id" value="<?php echo $row['id']; ?>" >
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">功能: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $func; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">购置日期: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="date" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $date; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">所有人: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" name = "owner1" value="<?php echo $owner; ?>" >
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">出借次数: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $lent_time; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark">修理次数: <span class="tx-danger"></span></label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $rep_time; ?>" readonly>
                                                </div>
                                            </div>
                                            <!-- form-layout-footer -->
                                        </div>
                                    ...
                                    <div class="col-xl-6 mg-t-20 mg-xl-t-0">
                                        <div class="form-layout form-layout-5">
                                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 tx-md-24 mg-b-10">机器信息</h6>
                                            <p class="mg-b-30 tx-gray-600">机器状态.</p>
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark"><span class="tx-danger"></span> 工作面积:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" name = "mac_area" class="tx-14 tx-md-24 tx-dark" value="<?php echo $area; ?>" >
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-20">
                                                ...
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" name = "mac_usable" class="tx-14 tx-md-24 tx-dark" value="<?php echo $usable; ?>" >
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark"><span class="tx-danger"></span> 工作状态:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $lent1 ; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark"><span class="tx-danger"></span> 工作订单:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $row['lent']?$row['ord_id']:"" ; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark"><span class="tx-danger">*</span> 修理状态:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <select name="rep_update" class=" tx-14 tx-md-24 tx-dark" required>
                                                    <?php 
                                                    if($row['lent']==1) {echo "<option class=\"tx-14 tx-md-24 tx-dark\"s>" . "未修理" . "</option>";}
                                                    else {   
                                                        echo "<option value=0 " . ($row['repaired']?"":"selected=\"selected\"") . "class=\"tx-14 tx-md-24 tx-dark\">" . "未修理" . "</option>";
                                                        echo "<option value=1 " . ($row['repaired']?"selected=\"selected\"":"") . "class=\"tx-14 tx-md-24 tx-dark\">" . "修理中" . "</option>";
                                                    }?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14 tx-md-24 tx-dark"><span class="tx-danger"></span> 修理订单:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14 tx-md-24 tx-dark" value="<?php echo $row['repaired']?$row['rep_id']:"" ; ?>"  readonly>
                                                </div>
                                            </div>
                                            <!-- row -->
                                            <div class="row mg-t-30">
                                                <div class="col-sm-8 mg-l-auto">
                                                    <div class="form-layout-footer">
                                                        <input type="submit" formid="1" class="btn btn-custom-primary" name="sub_ord" value="修改信息">
