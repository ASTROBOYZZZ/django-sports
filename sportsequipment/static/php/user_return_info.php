...
<html lang="zxx">
   <head>
      ...
      <title>归还信息查看 | Return Info Manage Center</title>
      <!-- Main CSS -->			
...
<?php
    ...
    $ret_id = test_input($_GET["ret_id"]);
    setrawcookie('userName', $user_name);
    setrawcookie('userPhone', $user_phone);
    setrawcookie('ret_id', $ret_id);

if ($ret_id == 0) {
    header('location:return_info_search.html');
    exit;
}
                  ...
                  <ul class="accordion-menu">
                     <li class="open active">
                        ...
                        <ul class="sub-menu" style="display: block;">
                           ...
                           <li class="active"><a href="user_return_info.php?ret_id=0">还单信息</a></li>
               ...
               <div id="main-wrapper">
                  ...
                  <div class="pageheader pd-t-25 pd-b-35">
                     <div class="pd-t-5 pd-b-5">
                        <h1 class="pd-0 mg-0 tx-20">还单信息 | Return Monitoring</h1>
                     </div>
                     <div class="breadcrumb pd-0 mg-0">
                        <a class="breadcrumb-item" href="index.html"><i class="icon ion-ios-home-outline"></i> Home</a>
                        <a class="breadcrumb-item" href="">Dashboard</a>
                        <!-- here to design -->
                        <span class="breadcrumb-item active">Return Monitoring</span>
                     </div>
                  </div>
                  <!--/ Breadcrumb End -->
                  <!--================================-->
                ...
                if ($conn) {
                    //link success
                    $sql_select = "select * from misaki_joy.return where misaki_joy.return.id = $ret_id";
                    //set code 
                    ...
                    if ($sql_return) {
                        ...
                        if ($row == NULL || $ret_id != $row["id"]) {
                            echo "<script type=" . "\"" . "text/javascript" . "\"" . ">" . "window.alert" . "(" . "\"" . "非法的查询" . "\"" . ")" . ";" . "</script>";
                            echo "<script type=" . "\"" . "text/javascript" . "\"" . ">" . "window.location=" . "\"" . "return_info_search.html" . "\"" . "</script>";
                            exit;
                        }

                        
                        $acc1 = $row['accept'];
                        $acc2 = $col1 = $title1 = $title2 = "";
                        switch ($acc1){
                            case "1":$acc2="未审批";$col1="danger";$title1="还单审核中";$title2="请等待管理员审核";break;
                            case "2":$acc2="已通过";$col1="success";$title1="还单已通过";$title2="本次农机租赁已结束";break;
                            case "3":$acc2="未通过";$col1="danger";$title1="还单被拒绝";$title2="请返回订单中心重新申请还单";break;
                            case "4":$acc2="已过期";$col1="danger";$title1="还单已过期";$title2="请返回订单中心重新申请还单";break;
                            default:$acc2 = $title1 = $title2 = "非法操作";$col1="danger";$form_c="disabled";
                        }
                        
                        $ord_id = $row['ord_id'];
                        $ret_area = $row['area'];
                        $ret_usable = $row['usable'];
                        $ret_date = $row['date'];
                        $mac_id = $row['mac_id'];
                        $loc_num = $row['loc_num'];
                        $loc_txt = $row['loc_txt'];
                        
                        //get info(user name, date, phone(adding: mac_area, mac_usable))  from order
                        $sql_select = "select * from misaki_joy.order where misaki_joy.order.id = $ord_id";
                        $sql_return = mysqli_query($conn, $sql_select);
                        $row = mysqli_fetch_array($sql_return);
                        // $user_name = $row['user_name'];
                        $ord_date = $row['date'];
                        $mac_area = $row['mac_area'];
                        $mac_usable = $row['mac_usable'];;
                        $ord_phone = $row['phone'];
                        $value = $row['value'];
                        if($user_phone != $ord_phone) {
                            echo "<script type=" . "\"" . "text/javascript" . "\"" . ">" . "window.alert" . "(" . "\"" . "您无权查看别人的还单" . "\"" . ")" . ";" . "</script>";
                            echo "<script type=" . "\"" . "text/javascript" . "\"" . ">" . "window.location=" . "\"" . "return_info_search.html" . "\"" . "</script>";
                            exit;
                        }

                        //get info(func) from return 
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-layout form-layout-4">
                                            ...
                                            <div class="row">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">订单序号: </label>
                                            ...
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">下单日期: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            ...
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">原可用度: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14  tx-md-24 tx-dark" value="<?php echo $mac_usable; ?>" readonly></textarea>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">原工作面积: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14  tx-md-24 tx-dark" value="<?php echo $mac_area; ?>" readonly></textarea>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">机器编号: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14  tx-md-24 tx-dark" name="mac_id" value="<?php echo $mac_id; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">机器功能: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="tx-14  tx-md-24 tx-dark" value="<?php echo $func; ?>" readonly>
                                                </div>
                                            </div> 
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark">租金: </label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    ...
                                    <div class="col-xl-6 mg-t-20 mg-xl-t-0">
                                        <div class="form-layout form-layout-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class=" col-sm-10 form-control tx-<?php echo $col1;?>" value="<?php echo $acc2; ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark"> 归还日期:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="date" formid="1" class="col-sm-10 tx-14  tx-md-24 tx-dark" name="ret_date" value="<?php echo $ret_date;?>" readonly>
                                                </div>
                                            </div>
                                            
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark"> 归还时可用度:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="col-sm-10 tx-14  tx-md-24 tx-dark" name="usable" value="<?php echo $ret_usable;?>"  readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark"> 本次工作面积:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="text" formid="1" class="col-sm-10 tx-14  tx-md-24 tx-dark" name="area" value="<?php echo $ret_area;?>" readonly>
                                                </div>
                                            </div>
                                            <!-- row -->
                                            
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark"> 路径坐标点数目:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <input type="number" formid="1" class="col-sm-10 tx-14  tx-md-24 tx-dark" value="<?php echo $loc_num;?>"  readonly>
                                                </div>
                                            </div>
                                            <div class="row mg-t-20">
                                                <label class="col-sm-4 form-control-label tx-14  tx-md-24 tx-dark"> 工作地点:</label>
                                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                                    <textarea rows="10" class="col-sm-10 tx-14  tx-md-24 tx-dark tx-14  tx-md-24 tx-dark" value="<?php echo $loc_txt;?>"  readonly><?php echo $loc_txt;?></textarea>
                                                </div>
                                            </div>
                                            <!-- row -->
